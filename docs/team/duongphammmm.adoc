...
** Updated the <<Contributions to the User Guide, User Guide>> to reflect my feature enhancements. Sections contributed includes:
*** About this guide
*** Viewing help: `help`
*** Adding an item: `add`
*** Generating a resume: `rgen`

** Updated the <<Contributions to the Developer Guide, Developer Guide>> to reflect my feature enhancements. Sections contributed includes:
*** Model Component
*** Export Feature
