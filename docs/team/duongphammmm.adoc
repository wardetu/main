...
** Updated the <<Contributions to the User Guide (Extracts), User Guide>> to reflect my feature enhancements. Sections contributed includes:
*** About this guide
*** Viewing help: `help`
*** Adding an item: `add`
*** Generating a resume: `rgen`

** Updated the <<Contributions to the Developer Guide (Extracts), Developer Guide>> to reflect my feature enhancements. Sections contributed includes:
*** Model Component
*** Export Feature
