...
=== 1.3 About my Role
In the initial phase of the project, I was tasked to morph the `Parser` in the application to suit the needs of our application. Over time, we developed by features and I was tasked to write the Resume Edit and Tag Pull feature.
