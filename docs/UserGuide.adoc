...
****
*Format:* `me [dp/ FILEPATH] [n/ NAME] [d/ DESCRIPTION] [p/ PHONE] [e/ EMAIL] [g/ GITHUB] [u/ UNIVERSITY] [m/ MAJOR] [f/ FROM] [t/ TO] [c/ CURRENT_CAP MAX_CAP]`
****
...
|Note |`add i/ note n/ NAME t/ TIME`
|=======================================================================

[TIP]
The description of a `Resume` could be written in one paragraph (with *full stop* and a *space* after each sentence).
