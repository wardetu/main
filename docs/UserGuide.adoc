...
|icon:fa-info-circle[role="blue"] | Important information to take note
|icon:fa-lightbulb-o[role="yellow"] | Tips
|icon:fa-exclamation-triangle[role="red"] | Warnings on potential misuse
