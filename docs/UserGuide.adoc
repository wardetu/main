...
image::user_profile.png[width="300"]
...
Suppose the `resume` at index 2 is named _"Summer Internship"_. A pop-up window will be opened,
featuring a text-based view of the content of _"Summer Internship"_.
