...
. All `resume` items are listed in the list box. Assuming you want to edit the `resume` item at index 1.
+
image::ListResume2.png[width="790"]

. The `resume` at index 1 has its name changed from _"Winter 2019"_ to _"Software Engineering Resume"_ and its tag set to _"agile"_.
+
...
. All `skill` items are listed in the list box. Assuming you want to edit the `skill` item at index 2.
+
