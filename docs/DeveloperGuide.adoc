...
** Pros: Better clarity in expressing that `redit` and `edit` are different commands.
...
** Cons: The functionality of `ResumeEditCommand` may be limited, and could have been combined with `EditCommand` entirely.
