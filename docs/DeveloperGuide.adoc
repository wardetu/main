...
** Pros: Is designed to replace `Observable` and `Observer` and the industry standard.
...
We would, however, make it a priority to change the implementation to Alternative 1, since we want to scale up
