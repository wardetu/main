...
****
*Conclusion:* Given that the application already have quite a number of panels (User Profile, Command Input,
Command Result, Item Detail and List View), alternative 1 was chosen to minimise the layout and improve on user experience.
...
will further allows the application to have more control of the formatting of the output file, and leaving room for potential
