...
The Export Resume feature supports two main actions: previewing the content of a `Resume` item in textual format, and
...
Step 2. The user executes `rgen INDEX n\FILE_NAME [TEMPLATE_NAME]`. If the specified resume index is out of bound,
