...
public class EditCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        List<Item> lastShownList = model.getFilteredPersonalDetailList();
        ...
        if (!itemToEdit.isSame(editedItem) && model.hasPersonalDetail(editedItem)) {
            throw new CommandException(MESSAGE_DUPLICATE_PERSON);
        }

        model.setPersonalDetail(itemToEdit, editedItem);
        model.updateFilteredPersonalDetailList(PREDICATE_SHOW_ALL_ITEMS);
        return new CommandResult(editedItem.toString(), String.format(MESSAGE_EDIT_PERSON_SUCCESS, editedItem));
    }
