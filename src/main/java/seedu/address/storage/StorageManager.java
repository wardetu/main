...
/**
 * Manages storage of Resume Book data in local storage.
 */
public class StorageManager implements Storage {
    ...
    public void saveResumeBook(ReadOnlyResumeBook resumeBook) throws IOException {
        saveResumeBook(resumeBook, resumeBookStorage.getResumeBookFilePath());
    }

    @Override
    public void saveResumeBook(ReadOnlyResumeBook resumeBook, Path filePath) throws IOException {
        logger.fine("Attempting to write to data file: " + filePath);
        resumeBookStorage.saveResumeBook(resumeBook, filePath);
    }
