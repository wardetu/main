...
public class TypicalPersonalDetails {
    ...
    public static final PersonalDetail DANIEL = new PersonalDetailBuilder().withName("Daniel Meier").withPhone("87652533")
    ...
    public static final PersonalDetail AMY = new PersonalDetailBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final PersonalDetail BOB = new PersonalDetailBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
